...
TOOL_CATEGORIES: Mapping[str, tuple[str, ...]] = MappingProxyType(
    {
        ...
        "plan": ("write_plan",),
        "writing_readiness_read": ("get_writing_readiness",),
        "writing_start": ("authorize_writing_request",),
        "writing_readiness_review": ("submit_writing_readiness_review",),
        "chapter_read": (
            "list_volumes",
            "list_chapters",
            "read_chapter",
...
TOOL_CATEGORY_DISPLAY: Mapping[str, str] = MappingProxyType(
    {
        ...
        "interaction": "提问",
        "plan": "计划",
        "writing_readiness_read": "创作准备状态读取",
        "writing_start": "首次正文授权",
        "writing_readiness_review": "创作准备审查",
        "chapter_read": "章节读取",
        "summary_read": "摘要读取",
        "character_read": "角色读取",
