(() => {
  ...
  const translations = {
    zh: {
      ...
      "showcase.mark": "真实工作台",
      "showcase.title": "写作在中央，<em>AI 在身旁</em>",
      "showcase.text": "章节树、沉浸式编辑器与 Agent 面板并肩展开。上下文、推理过程和每一处文本变更，都在同一个视野中。",
      "showcase.alt": "OmniFic 工作台：左侧卷章结构，中间小说编辑器，右侧 Agent 协作面板",
      "local.mark": "本地优先",
    ...
    en: {
      ...
      "showcase.title": "Writing at the center. <em>AI at your side.</em>",
      "showcase.text": "The chapter tree, focused editor, and Agent panel sit side by side. Context, reasoning progress, and every text change stay within a single view.",
      "showcase.alt": "The OmniFic workspace with a volume and chapter tree, novel editor, and Agent collaboration panel",
