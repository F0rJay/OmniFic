(() => {
  ...
  const translations = {
    zh: {
      ...
      "workflow.createText": "在清晰的三栏工作区持续写作，自动保存每一次推进。",
      ...
      "features.writingText": "卷章结构、自动保存、查找替换、自由排序与 Markdown 导出，让数十万字依然清晰可控。",
      "features.worldTitle": "人物与世界书",
      "features.worldText": "集中维护人物、地点、规则与研究资料，支持通用格式导出并让 Agent 随时检索。",
      "features.agentTitle": "可执行任务的 Agent",
      "features.agentText": "读取、搜索和修改创作内容，支持首次开写准入、审批、变更预览、子 Agent 与持续任务。",
    ...
    en: {
      ...
      "workflow.createText": "Draft in a clear three-panel workspace while every step is saved automatically.",
      ...
      "features.writingText": "Volume and chapter structure, autosave, find and replace, flexible ordering, and Markdown export keep hundreds of thousands of words manageable.",
      "features.worldTitle": "Characters and worldbooks",
      "features.worldText": "Keep people, places, rules, and research together, export them in portable formats, and make them ready for Agents to retrieve.",
      "features.agentTitle": "Agents that can do the work",
      "features.agentText": "Read, search, and edit creative material with a first-draft readiness gate, approvals, change previews, delegated Agents, and persistent tasks.",
